                ...
                <div class="section-body">
                    <div class="row">
                        <div class="col-12 col-md-4 col-lg-4">
                            <div class="card">
                                <form action="dispatcher.php?action=saveClient" method="post">
                                    <div class="card-header">
                                        <h4>Enregistrer nouveau client</h4>
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="col-12 col-md-8 col-lg-8">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Vendre unités | Liste clients</h4>
                                </div>
                                <div class="card-body">
                                            ...
                                            <?php
                                                foreach ($resultBD as $client){
                                                    echo "<tr>";
                                                        ...
                                                        echo "<td><a href='dispatcher.php?action=displayFormConfirmerVenteUnite&idClient=".$client['id']."&nomClient=".$client['nom']."&tel=".$client['tel']."' class='btn btn-outline-warning'><i class='fas fa-edit'></i></a></td>";
                                                    echo "</tr>";
                                                }
                                            ?>
                                            </tbody>
