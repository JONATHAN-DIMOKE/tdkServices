                                            ...
                                            <div class="table-responsive"><br>
                                                <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                                    ...
                                                    foreach ($listCommissionDuJour as $commission){
                                                        ...
                                                        echo "<td class='badge badge-info'>".$commission['reseauCOM']."</td>";
                                                        ...
                                                        echo "<td>".$commission['beneficeCDF']."</td>";
                                                        echo "<td>".$commission['beneficeUSD']."</td>";
                                                        echo "<td class='badge badge-success'>".$commission['dateComplet']."</td>";
