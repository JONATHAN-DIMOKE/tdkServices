                                    ...
                                    <div class="table-responsive">
                                        <table id="mainTable" class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <th>Transaction USD</th>
                                                <th>Transaction CDF</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <?php
                                            foreach ($listReseaux as $reseau){
                                                ...
                                                echo "<td><button class='btn btn-outline-success' id='btnTransactionUSD' ><i class='fas fa-dollar-sign'></i></button></td>";
                                                echo "<td><button class='btn btn-outline-warning' id='btnTransactionCDF'><i class='fas fa-edit'></i></button></td>";
                                                echo "</tr>";
                                            }
                                            ?>
                                            </tbody>
...
<script>
    $(document).ready(function() {
        $('a[id=btnTransactionUSD],button[id=btnTransactionUSD]').click(function () {
            ...
            $.ajax({
                url:"dispatcher.php?action=conformTransactionE_banking",
                type:'POST',
                data:{"idTel":data[0],
                    "reseau":data[1],
                    "devise":'USD',
...
<script>
    $(document).ready(function() {
        ...
        $('a[id=btnTransactionCDF], button[id=btnTransactionCDF]').click(function () {
            var data = $(this).closest('tr').children('td').map(function () {
                return $(this).text();
            }).get();
