                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Réabonner décodeur | Liste code décodeur de <?= $_GET['nomClient']?></h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="mainTable" class="table table-striped">
                                            ...
                                            <tbody>
                                            <?php
                                            foreach ($listCodeDecodeur  as $code){
                                                echo "<tr>";
                                                echo "<td hidden>".$code['id']."</td>";
                                                echo "<td >".$code['denomination']."</td>";
                                                echo "<td>".$code['codeDecodeur']."</td>";
                                                echo "<td></td>";
                                                echo "<td hidden>".$code['idClient']."</td>";
                                                echo "<td><button class='btn btn-outline-success' id='btnReabonner' ><i class='fas fa-save'></i></button></td>";
                                                echo "</tr>";
                                            }
                                            ?>
                                            </tbody>
...
<script>
    $(document).ready(function() {
        ...
        $('a[id=btnReabonner],button[id=btnReabonner]').click(function () {
            ...
            $.ajax({
                url:"dispatcher.php?action=confirmerReabonnement",
                type:'POST',
                data:{
                    "denomination":data[1],
                    "codeDecodeur":data[0],
