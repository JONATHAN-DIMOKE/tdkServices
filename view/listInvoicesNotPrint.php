                        ...
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Liste factures non imprimées</h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                            ...
                                            <tbody>
                                            <?php
                                            foreach ($listInvoicesNotPrinted as $line){
                                                echo "<tr>";
                                                echo "<td hidden>".$line['id']."</td>";
                                                echo "<td>".$compteur."</td>";
                                                echo "<td>".$line['nom']."</td>";
                                                echo "<td>".$line['refVente']."</td>";
                                                echo "<td>".$line['montantCDF']."</td>";
                                                echo "<td>".$line['montantEnUnite']."</td>";
                                                echo "<td>".$line['dateVente']."</td>";
                                                echo "<td>".$line['tel']."</td>";
                                                echo "<td  class='badge badge-info'>".$line['etatTraitement']."</td>";
                                                echo "<td><a href='dispatcher.php?action=displayFormConfirmerVenteUnite&idClient=".$line['id']."&nomClient=".$line['nom']."&tel=".$line['tel']."' class='btn btn-outline-warning'><i class='fas fa-print'></i></a></td>";
                                                echo "</tr>";
                                                $compteur++;
                                            }
                                            ?>
