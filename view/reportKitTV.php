                                        ...
                                        <div class="row">
                                            ...
                                            <div class="table-responsive"><br>
                                                <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                                    ...
                                                    <tbody>
                                                    <?php
                                                    foreach (LigneRechargeDAO::getAllKitRespTK($_SESSION['user']['id']) as $kit){
                                                        echo "<tr>";
                                                        echo "<td hidden>".$kit['id']."</td>";
                                                        echo "<td class='badge badge-info'>".$kit['denominationK']."</td>";
                                                        echo "<td>".$kit['stockinitialK']."</td>";
                                                        echo "<td>".$kit['approvK']."</td>";
                                                        echo "<td>".$kit['newStockK']."</td>";
                                                        echo "<td>".$kit['venteK']."</td>";
                                                        echo "<td>".$kit['puK']."</td>";
                                                        echo "<td>".$kit['soldeK']."</td>";
                                                        echo "<td>".$kit['stockRestantK']."</td>";
                                                        echo "<td class='badge badge-success'>".$kit['dateComplet']."</td>";
                                                        echo "<td>".$kit['nom']."</td>";
                                                        echo "</tr>";
                                                    }
                                                    ?>
